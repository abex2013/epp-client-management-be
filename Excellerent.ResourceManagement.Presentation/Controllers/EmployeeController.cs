...
namespace Excellerent.ResourceManagement.Presentation.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public  ResponseDTO EditEmployee(Employee employeeEntity)
        {
            return  new ResponseDTO(ResponseStatus.Info,"Update Succesfull", _employeeService.UpdateEmployee(employeeEntity));
        }
